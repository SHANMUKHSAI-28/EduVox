    ...
    <div className={`rounded-md p-4 ${alertStyle.bg} ${alertStyle.border} border ${className}`}>
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className={`text-sm ${alertStyle.text} ${title ? 'mt-2' : ''}`}>
            {children}
          </div>
        </div>
        {onClose && (
          <div className="ml-auto pl-3">
            <div className="-mx-1.5 -my-1.5">
              <button
                onClick={onClose}
                className={`inline-flex rounded-md p-1.5 ${alertStyle.text} hover:bg-opacity-20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-50 focus:ring-green-600`}
              >
