            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center">
                <button
                  ...
                  className="lg:hidden rounded-xl p-2 text-secondary-400 hover:text-secondary-600 hover:bg-secondary-100/50 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-200"
                >
                ...
                {stats.map((stat, index) => (
                  <div key={stat.name} className="group">
                    <div className="bg-white/70 backdrop-blur-xl overflow-hidden shadow-xl rounded-2xl border border-white/20 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                      <div className="p-6">
                        <div className="flex items-center">
                          <div className="flex-shrink-0">
                            <div className={`${stat.color} rounded-2xl p-4 text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                              {stat.icon}
                            </div>
                          </div>
                          <div className="ml-5 w-0 flex-1">
                            <dl>
                              <dt className="text-sm font-semibold text-secondary-600 truncate">
                                {stat.name}
                              </dt>
                              <dd className="text-2xl font-bold text-secondary-900 mt-1">
                                {stat.value}
                              </dd>
                            </dl>
                          </div>
                      ...
                      <div className="bg-gradient-to-r from-primary-50 to-accent-50 px-6 py-3">
                ...
                <div className="px-8 py-6">
                  ...
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    {quickActions.map((action) => (
                      <div
                        key={action.name}
                        className="group relative rounded-2xl border-2 border-secondary-200 bg-white/50 backdrop-blur-sm px-8 py-6 shadow-lg hover:border-primary-300 hover:shadow-xl hover:scale-105 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary-500 cursor-pointer transition-all duration-300"
                      >
                        <div className="flex items-center space-x-4">
                          <div className="flex-shrink-0">
                            <div className={`${action.color} rounded-2xl p-4 text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                              {action.icon}
                            </div>
                          </div>
                          <div className="flex-1 min-w-0">
                            <a href={action.href} className="focus:outline-none">
                              ...
                              <p className="text-lg font-bold text-secondary-900 group-hover:text-primary-600 transition-colors">
                                {action.name}
                              </p>
                          ...
                          <div className="flex-shrink-0">
                            <svg className="w-6 h-6 text-secondary-400 group-hover:text-primary-500 group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl border border-white/20">
                <div className="px-8 py-6">
                  ...
                  <div className="text-center py-16">
                    <div className="mx-auto w-24 h-24 bg-gradient-to-br from-secondary-100 to-secondary-200 rounded-full flex items-center justify-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-secondary-900 mb-2">No recent activity</h3>
                    <p className="text-secondary-600 max-w-md mx-auto leading-relaxed">
